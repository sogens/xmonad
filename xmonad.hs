...
myWorkspaces = [" term ", " www ", " sys ", " files ", " vbox ", " chat ", " music ", " vid ", " emacs "]
...
main = do
  ...
  xmproc0 <- spawnPipe ("xmobar -x 0 /home/jason/.config/xmobar/" ++ colorScheme ++ "-xmobarrc")
  xmproc1 <- spawnPipe ("xmobar -x 1 /home/jason/.config/xmobar/" ++ colorScheme ++ "-xmobarrc")
